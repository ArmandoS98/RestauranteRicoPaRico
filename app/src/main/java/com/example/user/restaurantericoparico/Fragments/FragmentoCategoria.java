...
import com.example.user.restaurantericoparico.Adaptadores.AdaptadorCategorias;
import com.example.user.restaurantericoparico.Entidades.Comida;
...
public class FragmentoCategoria extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragmento_grupo_items, container, false);

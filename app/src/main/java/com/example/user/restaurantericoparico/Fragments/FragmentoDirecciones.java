...
import com.example.user.restaurantericoparico.Adaptadores.AdaptadorDirecciones;
import com.example.user.restaurantericoparico.R;
import com.example.user.restaurantericoparico.Utilidades.DecoracionLineaDivisoria;
...
public class FragmentoDirecciones extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragmento_direcciones, container, false);
